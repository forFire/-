		...
		<div style="">
			<form id="ff" class="easyui-form" method="post" data-options="novalidate:true" action="">
				<table cellpadding="5">
					<tr>
						<td>ID</td>
						<td><input class="easyui-textbox" type="text" name="id"  id ="id" value=""></input></td>
					</tr>
			...
			<div style="text-align: center; padding: 5px">
				<a href="javascript:void(0)" class="easyui-linkbutton" onclick="updateform()">提交</a> <a href="javascript:void(0)" class="easyui-linkbutton" onclick="$('#updateCustomer').dialog('close');">关闭</a>
			</div>
		</div>
	</div>
